...
public abstract class ItemSwipeCallback extends ItemTouchHelper.SimpleCallback {
    ...
    private final int RIGHT_COLOR = R.color.color_primary_dark;
    private final int LEFT_COLOR = R.color.color_accent;
    private final int RIGHT_TEXT = R.string.account_address_remove;
    private final int LEFT_TEXT = R.string.account_address_edit;
